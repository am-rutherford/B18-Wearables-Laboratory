...
options.acc_threshold = 0.08*G;  %choose value
options.ssd_threshold = 0.08*G;  %choose value
options.time_threshold = 4; %[s]
...
%-------------------------------------------------------------------------%
options.MinPeakDistance = 0.29;    %choose value
options.MinPeakHeight = 0.05*G;      %choose value
%% Run Walking Detection and Step Detection Algorithm
%choose one of the filenames from the dataset and corresponding subject
%identifier
file_index = 4; %choose a value [1, 2, ..., N], where N are the number of files
